  ...
  return (
    <>
      ...
      {sizeModal && (
        ...
        >
          <div
            className={`bg-white max-sm:w-[95%] mx-auto p-5 sm:p-10 max-md:w-full max-lg:w-[35rem] max-lg:h-[35rem] overflow-y-auto`}
          >
            <div className={`border-b border-slate-300 pb-5`}>
              <div className={`flex justify-between items-center`}>
                <h3 className={`text-[1.5rem] font-bold`}>Tabele veličina</h3>
              </div>
              <p className={`mt-2`}>Izaberite željenu tabelu veličina</p>
            </div>
